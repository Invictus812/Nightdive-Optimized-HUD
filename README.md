...
After using several of NightFright2k19's _**excellent**_ HUDs from the his SBARDEF mod, but not finding any particular one to be _just right_ **for me**, and discovering that the Cacoco Editor:
1: exists, and
...
As such, no parts of this HUD are truly static, and it is allergic to the number 0.  It will not display information about something if you have no use for it, and it will not show you the same information in two separate places (no redundant information).  For example, for your standard pistol start:
...
The red fist in the bottom right next to the ammo counter is the berserk indicator.
...
Lizzie ShinKicker and Roman Formin - Cacoco Editor
NightFright2k19 and liPillON - Modified Nightdive HUDs for inspiration
